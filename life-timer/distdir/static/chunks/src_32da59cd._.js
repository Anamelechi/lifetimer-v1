...
function generateAstroQuote(sun, moon, asc) {
    ...
    const seed = (_opts_seed = opts.seed) !== null && _opts_seed !== void 0 ? _opts_seed : new Date().toISOString().slice(0, 10);
    const hash = [
        ...seed
    ...
    const tail = [
        ...
        city ? "from ".concat(city) : null
    ].filter(Boolean).join(" ");
    if (tail) text = "".concat(text, " ").concat(tail);
    return text;
}
function generateDailyInsight(param) {
    let { sun, moon, asc, seed } = param;
    ...
    if (m) spice.push("".concat(moon, " Moon"));
    if (a) spice.push("".concat(asc, " Rising"));
    const tag = spice.length ? " (".concat(spice.join(' • '), ")") : '';
    return {
        title,
        blocks: [
            p1 + tag,
...
function eclipticLongitude(body, date) {
    ...
    if (body === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Sun && typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SunPosition"] === 'function') {
        const sp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SunPosition"](date);
        return sp.elon;
    }
    if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EclipticLongitude"] === 'function') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EclipticLongitude"](body, date);
    }
    // Geocentric equatorial of date, with aberration
    const equ = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Equator"](body, date, null, true, true);
    const ecl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Ecliptic"](equ);
    return ecl.elon;
}
function formatOffset(secs) {
    ...
    return "UTC ".concat(sign).concat(String(h).padStart(2, '0'), ":").concat(String(m).padStart(2, '0'));
}
function BirthChartPage() {
    var _insight_blocks, _insight_blocks1;
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const birthOffsetFmt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[birthOffsetFmt]": ()=>formatOffset(store.birthUtcOffsetSeconds)
    }["BirthChartPage.useMemo[birthOffsetFmt]"], [
        store.birthUtcOffsetSeconds
    ]);
    const currentOffsetFmt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[currentOffsetFmt]": ()=>formatOffset(store.currentUtcOffsetSeconds)
    }["BirthChartPage.useMemo[currentOffsetFmt]"], [
    ...
    const moonSign = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[moonSign]": ()=>{
            try {
                ...
                const ecl = eclipticLongitude(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Moon, date);
    ...
    const ascendantDegrees = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[ascendantDegrees]": ()=>{
            try {
                if (!birthLocal || store.birthUtcOffsetSeconds == null || store.birthLat == null || store.birthLon == null) return null;
                const ms = birthLocal.getTime() - store.birthUtcOffsetSeconds * 1000;
                const date = new Date(ms);
                const gast = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SiderealTime"](date);
    ...
    const planets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[planets]": ()=>{
            if (!birthUtcIso) return [];
            const date = new Date(birthUtcIso);
            const bodies = [
                {
                    key: 'Sun',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Sun
                },
                {
                    key: 'Moon',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Moon
                },
                {
                    key: 'Mercury',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Mercury
                },
                {
                    key: 'Venus',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Venus
                },
                {
                    key: 'Mars',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Mars
                },
                {
                    key: 'Jupiter',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Jupiter
                },
                {
                    key: 'Saturn',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Saturn
                },
                {
                    key: 'Uranus',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Uranus
                },
                {
                    key: 'Neptune',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Neptune
                },
                {
                    key: 'Pluto',
                    body: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$astronomy$2d$engine$2f$esm$2f$astronomy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Body"].Pluto
                }
            ];
            const out = [];
            for (const { key, body } of bodies){
                try {
                    ...
                    const sign = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$astro$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toZodiacSign"])(lon);
    ...
    const chartSigns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[chartSigns]": ()=>{
            const set = new Set();
            if (sunSign) set.add(sunSign);
            if (moonSign) set.add(moonSign);
            if (ascendant) set.add(ascendant);
            for (const p of planets || []){
                if (p === null || p === void 0 ? void 0 : p.sign) set.add(p.sign);
            }
    ...
    const insight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BirthChartPage.useMemo[insight]": ()=>{
            const day = new Date().toISOString().slice(0, 10);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$astro$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateDailyInsight"])({
                sun: sunSign,
                moon: moonSign,
                asc: ascendant,
                seed: day
        ...
        "BirthChartPage.useEffect": ()=>{
            ...
            async function load() {
                try {
                    ...
                    const res = await fetch("/api/astro-note?".concat(params.toString()), {
                        cache: 'no-store'
                    });
                    ...
                    if (!aborted) {
                        ...
                        setNote((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$astro$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAstroQuote"])(sunSign, moonSign, ascendant, {
                            seed
                        }));
                    }
                }
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                store.birthTimeZone || '—',
                                                " ",
                                                birthOffsetFmt ? "(".concat(birthOffsetFmt, ")") : ''
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/birth-chart/page.js",
                                            lineNumber: 219,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: [
                                                ...
                                                " ",
                                                currentOffsetFmt ? "(".concat(currentOffsetFmt, ")") : ''
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/birth-chart/page.js",
                                            lineNumber: 221,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-2",
                                            children: birthUtcIso ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    ascendant ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: ascendantDegrees != null ? "".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$astro$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toZodiacSign"])(ascendantDegrees), " ").concat(Math.floor(ascendantDegrees % 30), "° ").concat(Math.floor((ascendantDegrees % 30 - Math.floor(ascendantDegrees % 30)) * 60), "'") : 'Angle: —'
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/birth-chart/page.js",
                                                                lineNumber: 234,
                                                                columnNumber: 22
                                                    ...
                                                    [
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-lg text-accent",
                                                                    children: label === 'Sun' ? (p === null || p === void 0 ? void 0 : p.sign) || sunSign || '—' : (p === null || p === void 0 ? void 0 : p.sign) || '—'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/birth-chart/page.js",
                                                                    lineNumber: 249,
                                                                    columnNumber: 23
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-xs text-white/50",
                                                                    children: p ? "".concat(p.sign, " ").concat(p.deg, "° ").concat(p.min, "' ").concat(p.sec, '"') : 'Longitude: —'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/birth-chart/page.js",
                                                                    lineNumber: 250,
                                                                    columnNumber: 23
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: note || (insight === null || insight === void 0 ? void 0 : (_insight_blocks = insight.blocks) === null || _insight_blocks === void 0 ? void 0 : _insight_blocks[0]) || '—'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/birth-chart/page.js",
                                                    lineNumber: 261,
                                                    columnNumber: 27
                                                }, this),
                                                !note && (insight === null || insight === void 0 ? void 0 : (_insight_blocks1 = insight.blocks) === null || _insight_blocks1 === void 0 ? void 0 : _insight_blocks1[1]) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BirthChartPage, "TvkMlACacTI/I9xSJQi44HaBEz8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
